...
public class MainRecyclerAdapter extends RecyclerView.Adapter {
    public enum ID {
        ID_GALLERY, ID_RECORDING, ID_TAKE_PHOTO, ID_PREVIEW, ID_STREAMING, ID_STREAMING_MUTE, ID_TEMPERATURE, ID_SETTING, ID_VIDEO
    }

    public String[] mTitles = new String[]{"GALLERY", "START RECORDING",
            "TAKE A PHOTO", "PREVIEW", "START RTMP STREAMING", "MUTE RTMP STREAMING",
            "TEMPERATURE ENABLED", "SETTING", "VIDEO"};
